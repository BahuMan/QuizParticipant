...
bool Input::hasBeenPressed(uint8_t pin) {
    ...
    switch(pin) {
        ...
        case PIN_B: result = B_prev; B_prev = false; break;
        case PIN_X: result = X_prev; X_prev = false; break;
        case PIN_Y: result = Y_prev; Y_prev = false; break;
        case PIN_MENU: result = MENU_prev; MENU_prev = false; break;
        case PIN_START: result = START_prev; START_prev = false; break;
        case PIN_JOY_X: result = JOY_X_prev; JOY_X_prev = false; break;
        case PIN_JOY_Y: result = JOY_Y_prev; JOY_Y_prev = false; break;
